        ...
        <div className="relative mx-auto max-w-7xl space-y-14 px-4 sm:px-6 lg:px-8">
          <header className="gsap-reveal rounded-[2rem] border border-white/60 bg-white/75 p-6 shadow-[0_20px_45px_-30px_rgba(10,22,40,0.45)] backdrop-blur sm:p-8">
            ...
            <p className="mt-3 max-w-3xl text-base leading-relaxed text-slate-600">
              K-Ré est né d&apos;une ambition simple: rendre les sports de pagaie
              accessibles, autonomes et mémorables pour tous les amoureux de l&apos;Île
              de Ré.
            </p>
          </header>

          <div className="grid items-center gap-8 lg:grid-cols-2">
            <div className="gsap-reveal space-y-4 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
              <h2 className="section-heading font-heading text-3xl font-bold tracking-tight text-brand-dark">
                Une aventure locale, une vision internationale
              </h2>
              <p className="leading-relaxed text-slate-700">
                Notre équipe locale développe des stations intégrées à
                l&apos;environnement côtier et à la vie insulaire. Chaque implantation
                est pensée pour préserver les sites naturels et offrir une
                expérience fluide aux visiteurs comme aux résidents.
              </p>
              <p className="leading-relaxed text-slate-700">
            ...
            <div className="relative h-80 overflow-hidden rounded-[2rem] border border-white/60 shadow-ocean sm:h-[430px]">
              <Image
          ...
          <section className="gsap-reveal relative overflow-hidden rounded-[2rem] bg-brand-dark p-8 text-white">
