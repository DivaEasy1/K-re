...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      'https://images.pexels.com/photos/12955798/pexels-photo-12955798.jpeg?auto=compress&cs=tinysrgb&w=1600',
    ],
  },
}
            ...
            <div className="relative grid gap-5 lg:grid-cols-[1.25fr_0.75fr]">
              <div>
                <h1 className="section-heading font-heading text-4xl font-bold tracking-tight text-brand-dark sm:text-5xl">
                  Activites premium pour tous les rythmes
                </h1>
                <p className="mt-3 max-w-3xl text-base leading-relaxed text-slate-600">
                  Nature, performance et moments conviviaux: choisissez un programme
                  moderne, clair et facile a reserver.
                </p>
              </div>
