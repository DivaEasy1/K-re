  ...
  return (
    <section className="bg-brand-light/80 py-24">
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        <div className="relative h-80 overflow-hidden rounded-[2rem] border border-white/60 shadow-ocean sm:h-[460px]">
          <Image
          ...
          <p className="absolute bottom-4 left-4 rounded-full border border-white/30 bg-white/10 px-3 py-1 text-xs font-semibold text-white backdrop-blur">
            Nature préservée • Île de Ré
          </p>
        </div>

        <div className="gsap-reveal rounded-[2rem] bg-white/80 p-6 shadow-[0_20px_45px_-30px_rgba(10,22,40,0.45)] backdrop-blur sm:p-8">
